...
public class autoLeft2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        tankDrive(DRIVE_SPEED,  5,  5, 2);
        tankDrive(TURN_SPEED, -20, 51, 4);
        tankDrive(DRIVE_SPEED, 22, 22, 4);
        tankDrive(DRIVE_SPEED, -4, -4, 2);
        sideDrive(DRIVE_SPEED, 25, 4);
